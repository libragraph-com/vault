...
@ApplicationScoped
@TaskIO(input = String.class, output = String.class, resources = "limited-service")
public class LimitedResourceTask implements VaultTask {

    @Override
    public String taskType() {
        return "test.limited-resource";
    }
