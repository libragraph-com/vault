 ~/.claude/plans/glowing-crafting-valley.md
...
do things. My requirements/advice are subject to scrutiny. Goal is to get what
we need while leveraging momentum/consensus where possible.

I want to combine 2 goals: 1) system design and 2) component docs.

The docs need to be concise and easily read by humans and AIs to clarify this projects
...
Any detailed design artifacts that emerge from this process need to be
added to docs/research and referenced from .md file.

Each md document is a disussion/review point. Many docs will reference each other.
...
The first pass on docs/*.md has been done. Review all work done thus far.

Make a plan to review and all docs with most important/leveraged first so we
can track progress/todos.
